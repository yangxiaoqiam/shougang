(function($){
    var bigColorPicker = new function(){
        ...
        this.init = function(){
            $("body").append('<div id="bigpicker" class="bigpicker"><ul class="bigpicker-bgview-text" ><li><div id="bigBgshowDiv"></div></li><li><input id="bigHexColorText" size="7" maxlength="7" value="#000000" /></li><li style="padding-left:15px;"><span id="closePicker">关闭</span></li><li><span id="clearColor">清除</span></li></ul><div id="bigSections" class="bigpicker-sections-color"></div><div id="bigLayout" class="biglayout" ></div></div>');
            ...
            $('#clearColor').click(function(){
                var dest = $(currentPicker).attr('dest');
                $('#'+dest).val('');
            });
        ...
        this.showPicker = function(callback,engine,sideLength_){
            ...
            if(engine == "L" ){
                ...
                bgmage.src = "../../../images/ver113/big_bgcolor.jpg";
                //初始化为默认样式
