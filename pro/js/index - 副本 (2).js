...
>>>>>>> 7d6d3728f8b44391ea3b4a837688bf5b1443791c
 //登录弹出框
...
>>>>>>> 7d6d3728f8b44391ea3b4a837688bf5b1443791c
        $(".side-nav .nav-li").hover(function() {
            $(this).children(".side-dropdown").slideToggle(300);
...
*/
 ...
 $(".side-nav .nav-li").hover(function() {
            $(this).children(".side-dropdown").css({"display":"block"});
            $(this).addClass("current");
            $(this).siblings().removeClass("current");
             $(this).siblings().children(".side-dropdown").css({"display":"none"});
...
>>>>>>> 7d6d3728f8b44391ea3b4a837688bf5b1443791c
  //change to sole
  $("#flex-btn1 a").click(function() {
    var index = $(this).index();
    $(this).addClass("current").siblings().removeClass("current");
     $(this).parent().parent().find(".isf").hide().eq(index).show();
...
<<<<<<< HEAD
  //change to sole
  $(".meeting-tab1 .pro-box-title span").mouseover(function() {
=======
  ...
  //change to sole
  $(".meeting-tab1 .pro-box-title span").click(function() {
>>>>>>> 7d6d3728f8b44391ea3b4a837688bf5b1443791c
          var index = $(this).index();
          $(this).addClass("current").siblings().removeClass("current");
          $(".meeting-tab1 .tabbox").hide().eq(index).show();       
  ...
  //change to sole
<<<<<<< HEAD
  $(".meeting-tab1 .pro-box-title span").eq(1).mouseover(function() {
=======
  $(".meeting-tab1 .pro-box-title span").eq(1).click(function() {
>>>>>>> 7d6d3728f8b44391ea3b4a837688bf5b1443791c
