        ...
        <div class="wh-container clearfix"  id="desktop_container_div"> 
		    ...
		    <ul class="wh-hd-r-nav clearfix" id="desktop_right_ul">
                ...
                <li <%=norhidehide%>>
                  ...
                  <li>
								     <a href="javascript:void(0)" class="wh-r-nav-a" tabindex="1"><i class="fa fa-qr-code fa-color"></i></a>
								     <div class="wh-hd-group-num wh-hd-box-shadow">
									       <span class="s-point"><em></em></span>
									       <div class="weixin-tan">
					                    <div class="qrcode">
					                        <img src="/defaultroot/upload/loginpage/201702/2017022809011583493514337.jpg">
					                    </div>
					                    <div class="arrow"></div>
			                    </div>
								     </div>
              ...
              <li>
								     <a href="javascript:void(0)" class="wh-r-nav-a" tabindex="1"><i class="fa fa-th-lists fa-color"></i></a>
								     <div class="wh-hd-group-num wh-hd-box-shadow hou-sys">
									       <span class="s-point"><em></em></span>
         ...
         <div class="system-tanbox clearfix">
                            <div class="system-tan">
									...
									<div class="site-count">
                                          ...
                                          <ul class="site-list clearfix">
												 ...
												 <li><a target="_blank" href="http://qglzaqd.sgqg.com:7003/mes-aqd-app/">冷轧AQD    </a></li>
												   <li><a target="_blank" href="http://10.3.247.27:7003/mes-coldrolling-app/#app">一冷轧MES    </a></li>
												 ...
												 <li><a target="_blank" href="http://qglz2ndmes.sgqg.com:7003/mes-coldrolling-app/">二冷轧MES    </a></li>
												  <li><a target="_blank" href="http://qglz1stwtm.sgqg.com:8003/wtm_cold_app/login.htm">一冷轧仓储    </a></li>
                                    ...
                                    <div class="site-count site-count1">
                                          ...
                                          <ul class="site-list clearfix">
												...
												<li><a target="_blank" href="http://10.3.50.85">IT运行管理系统   </a></li>
                ...
                <li><a href="/defaultroot/help/help_set.html"  target="_blank" class="wh-r-nav-a" title="帮助"><i class="fa fa-question-circle fa-color"></i></a></li>
 ...
 <div class="perbox-a">
     ...
     <a><img src="<%=_userImage_small%>" alt=""/></a>
      <div class="user-info">
        ...
        <div class="pernum fr">
                  ...
                  <div class="wh-hd-group-num wh-hd-box-shadow">
                     <div class="wh-hd-group-num-a">
						             <span class="s-point"><em></em></span>
                        <div class="wh-hd-group-a clearfix"><a href="#" class="fl" onclick="openInnerUser();return false;"><span title="全部人数">全部人数</span>：<em id="alluserNum">9974</em><b>人</b><i class="fa fa-user fa-color"></i></a></div>
                        <div class="wh-hd-group-a clearfix"><a href="#" class="fl" onclick="openUserList();return false;"><span title="当前在线">当前在线</span>：<em id="nowuserNum">4</em><b>人</b><i class="fa fa-angle-right"></i></a></div>
                  </div>
            </div>
          </div>
        </div>
           <a href="javascript:void(0)" title="<%=Resource.getValue(local,"common","comm.peels")%>" class="wh-sys-setting-skin-change welcome-skin-btn fr"  onclick="modiMySkinSC();return false;"><i class="fa fa-skin fa-color"></i></a>
           <div class="clear"></div>
   ...
   <ul class="clearfix" >
       <li>
          ...
          <div>
            <%if(!__isnoright){%>
				<p><i class="fa fa-envelope"></i><a href="#" title="发流程" onClick="jumpnew('platform/bpm/bpm_menu.jsp','/bpmscope!canStart.action?myCommon=0&moduleId=1');return false;">发流程</a></p>
				<p><i class="fa fa-envelope"></i><a href="#" title="站内信" onClick="javascript:openWin({url:'<%=rootPath%>/innerMail!openAddMail.action',isFull:true,winName:'newMail'});">站内信</a></p>
				<p><i class="fa fa-envelope"></i><a href="#" title="<%=Resource.getValue(local,"common","comm.mail")%>" onClick="javascript:window.open('<%=WriteURL%>','','');	">写邮件</a></p> 
				<p><i class="fa fa-step-pre fa-color"></i><a href="#" title="信息发布" onClick="javascript:openWin({url:'<%=rootPath%>/Information!add.action?channelType=0&userChannelName=信息管理&userDefine=0',isFull:true,winName:'newinfo'});">信息发布</a> </p>
				<%//hw 2017-1-2 modify
				if(showCreateMeetingNoteMenu(session.getAttribute("orgId")+"")){%>
        ...
        <li>
           <a href="#" onclick="javascript:window.open('<%=sjxURL%>','','');">
              <i class="i6"><span id="coremailNums">0</span></i>
              我的邮件
           </a>
       </li>
        <li>
           <a href="#" onclick="javascript:jumpnew('/defaultroot/innerMail!innermailMenu.action?expNodeCode=mymail','/defaultroot/innerMail!notreadMailList.action');" >
		   ...
		   <span class="s-point"><em></em></span>
		   <div>
				 <p remindModule="newMail" <%=_remindShow4%>><i class="fa fa-envelope"></i><a href="#" onclick="javascript:jumpnew('/defaultroot/innerMail!innermailMenu.action?expNodeCode=mymail','/defaultroot/innerMail!notreadMailList.action');"  title="站内信">站内信<!--新邮件--></a><span>(0)</span></p>
				<p remindModule="newJTMail" <%=_remindShow44%>><i class="fa fa-envelope"></i><a href="#" onclick="javascript:jumpnew('<%=rootPath%>/platform/system/transcenter/loginCheck.jsp?module=gov&reurl=<%=rootPath%>/innerMail!innermailMenu.action%3FexpNodeCode=mymail','<%=rootPath%>/platform/system/transcenter/loginCheck.jsp?module=gov&reurl=<%=rootPath%>/innerMail!notreadMailList.action');"  title="站内信(集团)">站内信(集团)<!--新邮件--></a><span>(0)</span></p> 
		   </div>
		   </div>
       </li>
        <li style="display:none;">
